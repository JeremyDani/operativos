...
class LugarAdmin(RestrictAdministradorGroupMixin, admin.ModelAdmin):
    ...
    def editar(self, obj):
        return format_html('<a class="btn" href="/admin/auxiliares/lugar/{}/change/"><i class="nav-icon fas fa-edit"></i></a>', obj.id)
    
    def eliminar(self, obj):
        return format_html('<a class="btn" href="/admin/auxiliares/lugar/{}/delete/"><i class="nav-icon fas fa-trash"></i></a>', obj.id)
